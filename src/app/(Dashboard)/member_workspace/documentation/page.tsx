    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8 animate-in fade-in duration-500">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <ul className="space-y-2 list-none">
            <li className="flex gap-2">
              <ArrowPoint /> <strong>Status Updates:</strong> Use the Task Board
              to drag-and-drop your tasks through the lifecycle (
              <em>Todo → In-Progress → Completed</em>).
            </li>
            <li className="flex gap-2">
              <ArrowPoint /> <strong>Security Restrictions:</strong> You can
              only modify tasks that have been officially assigned to you by a
              Project Manager.
            </li>
            <li className="flex gap-2">
              <ArrowPoint /> <strong>Collaboration:</strong> Open any task to
              view rich-text details, attachments, and the comment thread to
              discuss progress with your team.
            </li>
          </ul>
        </div>
      </CardSection>
      ...
      >
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <ul className="space-y-2 list-none">
            <li className="flex gap-2">
              <ArrowPoint /> View your personal task completion percentage.
            </li>
            <li className="flex gap-2">
              <ArrowPoint /> Monitor the progress of your colleagues to
              understand project bottlenecks.
            </li>
          </ul>
        </div>
      </CardSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="p-4 bg-muted rounded-xl border border-border">
            ...
            <p className="text-muted-foreground text-[11px]">
              Tasks close to your deadline will be highlighted in red or amber.
              Address these first.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-xl border border-border">
            <h4 className="font-bold text-foreground mb-1">Update Regularly</h4>
            <p className="text-muted-foreground text-[11px]">
              Keep your task status accurate so your Project Manager can rely on
              the live analytics.
            </p>
          </div>
        </div>
      ...
      <div className="bg-muted p-6 rounded-2xl border border-border flex items-center gap-4 text-muted-foreground">
        ...
        <div>
          ...
          <p className="text-xs">
            Your task updates and comments are logged for project transparency.
            Ensure all professional communications comply with company policy.
          </p>
        </div>
      </div>
    </div>
