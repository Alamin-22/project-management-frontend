      ...
      >
        <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
          <p>
            ...
            <strong>Manager Dashboard</strong>. The purpose of this interface is
            to provide a 30,000-foot view of your entire organization.
          </p>
          <ul className="space-y-2">
            ...
            <li>
              ...
              project-oriented. <em>Projects act as the root container.</em> All
              tasks, team members, and comments live inside the project context.
            </li>
          </ul>
        </div>
      </CardSection>
      ...
      >
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <ol className="space-y-2 list-decimal list-inside">
            ...
            <li>
              <strong>The Overview Hub:</strong> Click any project to enter its
              workspace. You will see these tabs:
            </li>
          </ol>
          <div className="grid grid-cols-2 gap-3 mt-2">
            ...
            <TabInfo name="Analytics" desc="Performance metrics per member." />
          </div>
        </div>
      </CardSection>
      ...
      >
        <div className="space-y-3 text-sm text-muted-foreground">
          ...
          <ul className="space-y-2">
            ...
            <li>
              • <strong>Restrictions:</strong> Unauthorized users (Team Members)
              are blocked from editing tasks not assigned to them via UI-locking
              and backend validation.
            </li>
            <li>
              • <strong>Content:</strong> Every task supports Rich-Text (Tiptap)
              descriptions and file attachments.
            </li>
            <li>
              • <strong>Comments:</strong> Use the comments section inside tasks
              to maintain team communication history.
            </li>
            <li>
              • <strong>Archiving:</strong> Tasks can be archived when completed
      ...
      >
        <div className="space-y-2 text-sm text-muted-foreground">
          ...
          <ul className="space-y-1">
            <li>
              • <strong>Team Analytics:</strong> See real-time progress bars for
              each member based on their `Todo` vs `Done` task count.
            </li>
            <li>
