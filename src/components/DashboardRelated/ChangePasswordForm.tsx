  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      <div className="bg-white border border-slate-300 rounded-2xl overflow-hidden ">
        {/* Visual Header */}
        <div className="bg-slate-50 p-8 border-b border-slate-100 flex items-center gap-5">
          <div className="h-12 w-12 bg-white rounded-2xl flex items-center justify-center text-slate-900 shadow-sm border border-slate-200">
        ...
        <Form {...form}>
          ...
          >
                  ...
                  <div className="relative">
                    <FormControl>
                      <Input
                        ...
                        className="h-12 rounded-xl bg-slate-50/50 border-slate-200 focus:bg-white transition-all pr-12"
                      />
                    </FormControl>
                    <button
                      type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-14 bg-slate-900 hover:bg-black text-white rounded-2xl font-black uppercase tracking-[0.15em] text-[11px] shadow-xl shadow-slate-100 transition-all active:scale-95 mt-4"
            >
              {isLoading ? (
                <>
